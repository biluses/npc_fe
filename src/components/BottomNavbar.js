...
const BottomNavbar = () => {
    ...
    return (
        <div className="bottombar">
            <div className=" w-full bottom-0 z-10 bg-white grid grid-cols-5 py-2 relative" style={{ boxShadow: "0pt -3pt 6pt #00000029" }}>
                <Link
                    href="/profile"
                    className={`flex flex-col items-center text-xs font-medium py-3 xs:px-4 px-3 flex-1 ${isActive(["/profile", "/friends", "/wardrobe"]) ? "text-black" : "text-[#78757E]"}`}
                >
                ...
                <Link href="#" className={`flex flex-col items-center text-xs font-medium py-3 xs:px-4 px-3 flex-1 ${isActive(["/community"]) ? "text-black" : "text-[#78757E]"}`}>
                ...
                <Link href="#" className={`flex flex-col items-center text-xs font-medium py-3 xs:px-4 px-3 flex-1 ${isActive(["/tokens"]) ? "text-black" : "text-[#78757E]"}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 32.417" className={isActive(["/tokens"]) ? "opacity-100" : "opacity-70"}>
                ...
                <Link href="#" className={`flex flex-col items-center text-xs font-medium py-3 xs:px-4 px-3 flex-1 ${pathname === "/store" ? "text-black" : "text-[#78757E]"}`}>
