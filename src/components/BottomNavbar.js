...
const BottomNavbar = () => {
    return (
        <div className="sticky max-w-[393pt] w-full bottom-0 z-10 bg-white  flex justify-between py-2" style={{ boxShadow: "0pt -3pt 6pt #00000029" }}>
            <Link href="/profile" className="flex flex-col items-center text-xs font-medium py-3 px-4 text-[#78757E] flex-1">
            ...
            <Link href="/community" className="flex flex-col items-center text-xs font-medium py-3 px-4 text-black flex-1">
            ...
            <button className="relative flex flex-col items-center flex-1">
                <div className="absolute bottom-7 left-1/2 transform -translate-x-1/2 p-5 rounded-full bg-black shadow-lg">
            ...
            <Link href="/tokens" className="flex flex-col items-center text-xs font-medium py-3 px-4 text-[#78757E] flex-1">
            ...
            <Link href="/store" className="flex flex-col items-center text-xs font-medium py-3 px-4 text-[#78757E] flex-1">
