...
const BottomNavbar = () => {
    ...
    return (
        <div className="sticky max-w-[393pt] w-full bottom-0 z-10 bg-white  flex justify-between py-2" style={{ boxShadow: "0pt -3pt 6pt #00000029" }}>
            ...
            <Link href="/community" className="flex flex-col items-center text-xs font-medium py-3 xs:px-4 px-3 text-black flex-1">
            ...
            <Link href="/tokens" className="flex flex-col items-center text-xs font-medium py-3 xs:px-4 px-3 text-[#78757E] flex-1">
            ...
            <Link href="/store" className="flex flex-col items-center text-xs font-medium py-3 xs:px-4 px-3 text-[#78757E] flex-1">
